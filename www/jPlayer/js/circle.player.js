...
var CirclePlayer = function(jPlayerSelector, media, options) {
	var	self = this,
		...
		defaults = {
			...
			supplied: "wav, m4a, oga",  //add wav - Dennis
...
CirclePlayer.prototype = {
	...
	setMedia: function(media) {
		//Dennis altered this function in order to be able to dynamically set the MEDIA file even after creation of the CirclePlayer
		//previous code snippet was not working.  
		var sound = {wav: media};
		this.player.jPlayer("setMedia", sound);
	},
	setVolume: function(newvolume) {
		//Dennis ADDED this function in order to be able to dynamically set the VOLUME even after creation of the CirclePlayer
		this.player.jPlayer("volume", newvolume);		
	},
	load: function() {
		//Dennis ADDED this function in order to preload audio file
